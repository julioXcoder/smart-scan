...
export const VideoSlashIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5l4.72-4.72a.75.75 0 011.28.53v11.38a.75.75 0 01-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 002.25-2.25v-9A2.25 2.25 0 0013.5 5.25h-9A2.25 2.25 0 002.25 7.5v9A2.25 2.25 0 004.5 18.75z" />
...
export const SettingsIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.11-.95.55.057 1.008.528 1.008 1.082V4.5a.75.75 0 001.5 0V3.94c0-1.226-1.02-2.186-2.25-1.985-1.25.206-2.25 1.41-2.25 2.68V4.5a.75.75 0 001.5 0v-.56zM6.31 5.31a.75.75 0 011.06 0l.69.69a.75.75 0 010 1.06l-1.06 1.06a.75.75 0 01-1.06-1.06l1.06-1.06-.69-.69a.75.75 0 010-1.06zM17.69 5.31a.75.75 0 010 1.06l-.69.69a.75.75 0 11-1.06 1.06l1.06-1.06a.75.75 0 011.06 0l.69.69a.75.75 0 010 1.06l-1.06 1.06a.75.75 0 01-1.06 0l.69-.69a.75.75 0 010-1.06l-1.06-1.06-.69.69a.75.75 0 01-1.06 0z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15a3 3 0 100-6 3 3 0 000 6z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75c-2.07 0-4.044.84-5.5 2.25-.92.899-1.5 2.15-1.5 3.5V18a2.25 2.25 0 002.25 2.25h10.5A2.25 2.25 0 0020.25 18v-.25c0-1.35-.58-2.601-1.5-3.5-1.456-1.41-3.43-2.25-5.5-2.25z" />
    </svg>
);
...
export const CloudIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15a4.5 4.5 0 004.5 4.5H18a3.75 3.75 0 001.332-7.257 3 3 0 00-5.433-2.261 4.5 4.5 0 00-8.442 2.516A4.5 4.5 0 002.25 15z" />
    </svg>
);